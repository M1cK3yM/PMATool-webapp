...
export function CreateConnectionDialog({
  ...
  console.log("CreateConnectionDialog dbConnection:", dbConnection)
      ...
      <DialogContent>
        ...
        <div className="grid gap-3">
          <div className="grid grid-cols-4 items-center gap-2">
            ...
            <Combobox choices={[{ value: "postgres", label: "postgres" }]} value={dbType} setValue={setDbType} defaultValue={dbType} placeHolder="Database" />
          </div>
          <div className="grid grid-cols-4 items-center gap-2">
